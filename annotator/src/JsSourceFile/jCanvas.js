...
!function (a, b, c) {
  ...
  function y(a, b, c, d) {
    ...
    if (d) {
      if (void 0 !== d.groups && null !== c.groups) for (g = 0; g < c.groups.length; g += 1) if (f = c.groups[g], e = j[f]) {
        for (i = 0; i < e.length; i += 1) if (e[i] === c) {
          h = i, e.splice(i, 1);
          break
        }
  ...
  function z(a) {
    var b, c, d, e;
    for (b = null, c = a.intersecting.length - 1; c >= 0; c -= 1) if (b = a.intersecting[c], b._masks) {
      for (e = b._masks.length - 1; e >= 0; e -= 1) if (d = b._masks[e], !d.intersects) {
        b.intersects = !1;
        break
      }
  ...
  function K(a, b, c) {
    var d, e, g, h;
    for (d in c) if (Object.prototype.hasOwnProperty.call(c, d) && (e = c[d], f(e) && (c[d] = e.call(a, b, d)), "object" === ta(e) && ua(e))) {
  ...
  var ja, ka = b.document, la = b.Image, ma = b.Array, na = b.getComputedStyle, oa = b.Math, pa = b.Number,
    qa = b.parseFloat, ra = a.extend, sa = a.inArray, ta = function (a) {
      return Object.prototype.toString.call(a).slice(8, -1).toLowerCase()
    }, ua = a.isPlainObject, va = oa.PI, wa = oa.round, xa = oa.abs, ya = oa.sin, za = oa.cos, Aa = oa.atan2,
    Ba = ma.prototype.slice, Ca = a.event.fix, Da = {}, Ea = {dataCache: {}, propCache: {}, imageCache: {}},
    Fa = {rotate: 0, scaleX: 1, scaleY: 1, translateX: 0, translateY: 0, masks: []}, Ga = {},
  ...
  d.baseDefaults = {
    ...
    if (0 !== h.length) if (b = h[0], c = s(b), d = c.layers, f(a)) for (g = 0; g < d.length; g += 1) e = d[g], a.call(b, e) && i.push(e); else i = d;
    return i
    ...
    if (0 !== i.length) if (b = i[0], c = s(b), d = c.layers, h = ta(a), a && a.layer) f = a; else if ("number" === h) a < 0 && (a = d.length + a), f = d[a]; else if ("regexp" === h) {
      for (g = 0; g < d.length; g += 1) if (e(d[g].name) && d[g].name.match(a)) {
        f = d[g];
        break
      }
    ...
    var b = this, c = b.getLayers(), d = b.getLayer(a);
    return sa(d, c)
  }, a.fn.setLayer = function (b, c) {
    var d, e, f, h, j, k, l, m = this;
    for (e = 0; e < m.length; e += 1) if (d = a(m[e]), f = s(m[e]), h = a(m[e]).getLayer(b)) {
    ...
    for (d = 0; d < h.length; d += 1) c = a(h[d]), e = s(h[d]), f = c.getLayers(), (g = c.getLayer(b)) && (g.index = sa(g, f), f.splice(g.index, 1), delete g._layer, x(c, e, g, {name: null}), y(c, e, g, {groups: null}), G(c, e, g, "remove"));
    return h
  }, a.fn.removeLayers = function (b) {
    var c, d, e, f, g, h, i = this;
    for (d = 0; d < i.length; d += 1) {
      for (c = a(i[d]), e = s(i[d]), f = c.getLayers(b), h = 0; h < f.length; h += 1) g = f[h], c.removeLayer(g), h -= 1;
    ...
    for (l = t.index, l || (l = 0), d = 0; d < r.length; d += 1) if (c = a(r[d]), e = h(r[d])) {
      for (n = s(r[d]), !1 !== t.clear && c.clearCanvas(), t.complete && (n.drawLayersComplete = t.complete), f = n.layers, k = l; k < f.length; k += 1) if (g = f[k], g.index = k, t.resetFire && (g._fired = !1), A(c, e, g, k + 1), g._masks = n.transforms.masks.slice(0), g._method === a.fn.drawImage && g.visible) {
        q = !0;
        break
      }
      if (q) continue;
    ...
    mouseup: "touchend",
    mousemove: "touchmove"
  }, Da.mouseEvents = {touchstart: "mousedown", touchend: "mouseup", touchmove: "mousemove"}, function (a) {
    var b;
    ...
    if (Da.drawings[g.type] && "function" !== g.type) f[Da.drawings[g.type]](b); else for (d = 0; d < f.length; d += 1) (e = h(f[d])) && (g = new c(b), H(f[d], g, b, a), g.visible && g.fn && g.fn.call(f[d], e, g));
    return f
    ...
    for (d = 0; d < p.length; d += 1) if ((e = h(p[d])) && (f = new c(b), H(p[d], f, b, a), f.visible)) {
    ...
    var d, e, f, g, i, j = this;
    for (d = 0; d < j.length; d += 1) if ((e = h(j[d])) && (f = new c(b), H(j[d], f, b, a), f.visible)) {
    ...
    for (d = 0; d < v.length; d += 1) if ((e = h(v[d])) && (f = new c(b), H(v[d], f, b, a), f.visible)) {
      ...
      } else for (k = 0; k < i.length; k += 1) j = i[k], u = f.y + k * f.height / i.length - (i.length - 1) * f.height / i.length / 2, e.shadowColor = f.shadowColor, e.fillText(j, t, u), "transparent" !== f.fillStyle && (e.shadowColor = "transparent"), 0 !== f.strokeWidth && e.strokeText(j, t, u);
    ...
    for (e = 0; e < o.length; e += 1) if (d = o[e], f = h(d), g = s(o[e]), f && (i = new c(b), H(d, i, b, a), r(o[e], f, i, i.width, i.height), null !== i.width && null !== i.height || (i.width = d.width, i.height = d.height, i.x = i.width / 2, i.y = i.height / 2), 0 !== i.width && 0 !== i.height)) {
      if (k = f.getImageData((i.x - i.width / 2) * g.pixelRatio, (i.y - i.height / 2) * g.pixelRatio, i.width * g.pixelRatio, i.height * g.pixelRatio), l = k.data, n = l.length, i.each) for (m = 0; m < n; m += 4) j = {
        r: l[m],
        g: l[m + 1],
        b: l[m + 2],
        a: l[m + 3]
